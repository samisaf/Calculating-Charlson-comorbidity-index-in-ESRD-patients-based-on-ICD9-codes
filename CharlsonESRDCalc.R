# See readme file. This script generates processes ICD9 codes, and produces a medical comrobidity table along with Charlson comorbidity index scores adjusted to ESRD
